/* 	$Id: orbfit.h,v 2.1 2002/01/20 22:09:09 garyb Exp $	 */
...
#define INVARIABLE_INCL ((23+22.11/3600.)*DTOR)
#define INVARIABLE_NODE ((3+(52.+23.7/60.)/60.)*DTOR)
...
xyz_ec_to_eq(double x_ec, double y_ec, double z_ec,
	     ...
	     double **partials);
void
eq_to_inv(double ra,   double dec,
	  double *lat, double *lon);
void
inv_to_eq(double lat, double lon,
